  ...
  return (
    <div className="mt-6 flex flex-col items-center">
      ...
      <thead className="mt-8">
        <tr>
          <th className="th rounded-tl-md">{t("correlation")}</th>
          <th className="th">{t("phaseCost")}</th>
          <th className="th">{t("items%")}</th>
          <th className="th">{t("phaseDur")}</th>
          <th className="th rounded-tr-md">{t("%cumulative")}</th>
        </tr>
      </thead>
      <tbody>
      ...
      <thead className="mt-12">
        <tr>
          <th className="th rounded-tl-md">{t("percOfInvoice")}</th>
          <th className="th">{t("phase")}</th>
          <th className="th rounded-tr-md">{t("no.")}</th>
        </tr>
      </thead>
      <tbody>
        <tr className="bg-white">
